...
import { ServeCliArgs, ParsedArgs, ServerBundle } from "./../definitions";
import { ProjectConfig } from "./../main";
import { prepareUrls, UrlList } from "./../utils/prepareURLs";
import { setupMockServer } from "../utils/setupMockServer";
import { produceBoilerplate, produceRoutesAndStore } from "../commands/produce";
import {
  delay,
  getModuleFromString,
  getTemplate,
...
class Serve {
  ...
  constructor(api: PluginAPI, options: ProjectConfig, args: ParsedArgs<ServeCliArgs>) {
    this.pluginApi = api;
  ...
  public async start() {
    const context = this.pluginApi.getCwd();

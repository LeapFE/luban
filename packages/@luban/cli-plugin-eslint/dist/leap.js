...
function eslintConfigLeap(api) {
    const eslintParser = "@typescript-eslint/parser";
    const parserOptions = new cli_shared_utils_1.SimpleMapPolyfill([["project", ["./tsconfig.json"]]]);
    const eslintExtends = ["leap"];
    const eslintEnv = new cli_shared_utils_1.SimpleMapPolyfill([["es2017", true]]);
    api.extendPackage({
        scripts: {
...
exports.eslintConfigLeap = eslintConfigLeap;
